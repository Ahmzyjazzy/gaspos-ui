...
export default function DefaultQuantityInput({quantity, onIncrease, onDecrease, onChange}: Props) {
  return (
      <div className="flex items-center justify-between space-x-2 px-5 py-2 bg-pos-input-light border border-pos-input-light rounded-3xl">
          <button
              onClick={onDecrease}
          ...
          <input
              ...
              className="w-full text-center text-sm font-bold bg-transparent outline-none text-white"
              min={1}
              autoComplete="off"
          />
          <button
